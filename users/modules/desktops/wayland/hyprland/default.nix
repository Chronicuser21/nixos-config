...
#        bathealth
      ...
      xdg.configFile."hypr/conf/startup.conf".text = ''
        exec-once = ${pkgs.swaybg}/bin/swaybg -i ${config.modules.desktops.hyprland.wallpaper} -m fill
        exec-once = ${pkgs.mako}/bin/mako --default-timeout 5000
      '';
    };
}
